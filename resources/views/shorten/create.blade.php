    ...
    <form action="{{route('shorten.store')}}" method="POST"  class='rounded shadow p-3 p-md-5 text-start' style='background-color:#fff;'>
        ...
        <div>
            ...
            <label class='form-label'>Url normal</label>
                <input type="text" id="normal_url" name="normal_url" class='form-control mb-3' disabled="disabled" required value="{{$full}}"> 
            <label class='form-label'>Url encurtada</label>    
                <input type="text" id="shortened_url" name="shortened_url" class='form-control mb-3' disabled="disabled" required value="{{$url}}">
        </div>
